(() => {
  // ===== CONFIG =====
  const LEAD_ENDPOINT = 'https://lead-relay.leestygpt.workers.dev/lead/GHPLYBQHAQ';
  ...
  const targets = document.querySelectorAll('.adv, .step, .review, .contact-card, .faq__item, .form-wrap, .hero__card, .service');
